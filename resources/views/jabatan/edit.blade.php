                    ...
                    <form action="{{ route('jabatan.update',['id' => $jabatan->id]) }}" method="post">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="nama" id="nama" value="{{ $jabatan->name }}">
                            </div>
                            <div class="form-group">
                                <label for="deskripsi">Deskripsi</label>
                                <textarea class="form-control" name="deskripsi" id="deskripsi">{{ $jabatan->description }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="status">Status</label>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" name="status" id="status" value="1" {{ $jabatan->status == 1 ? 'checked' : '' }}>
